...
exports.extraTrackAddingToggle = extraTrackAddingToggle;
...
function extraTrackAddingToggle() {
...
function fetchRandom() {
    return fetch('' + _constants.RANDOM_URL + _constants.RANDOM_NUMBER).then(function (res) {
        return res.json();
    }).then(function (json) {
