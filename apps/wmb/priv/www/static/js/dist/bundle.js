...
function addTrackToPlaylist(id, artist, title, file, album, cover) {
    ...
    (_console = console).info.apply(_console, arguments); // eslint-disable-line
    playerAPI.addSong = {
        _id: id,
        name: artist + ' - ' + title,
        url: encodeURI(file),
...
function fetchRandom() {
    return fetch('' + _constants.RANDOM_URL).then(function (res) {
        return res.json();
    }).catch(function (err) {
...
function fetchAlbum(albumId) {
    return fetch('' + _constants.ALBUMS_URL + albumId).then(function (res) {
        return res.json();
    }).catch(function (err) {
        return console.error(err);
    });
...
function fetchTrack(trackId) {
    return fetch('' + _constants.TRACKS_URL + trackId).then(function (res) {
        return res.json();
    }).catch(function (err) {
        return console.error(err);
    });
...
// module
exports.push([module.i, ".player-container {\n  height: 150px;\n  width: 100%; }\n\na:link, a:visited {\n  color: blue; }\n\nimg.album_cover {\n  width: 100%; }\n\ntable.album {\n  background-color: white;\n  width: 100%; }\n\ntable.main {\n  background-color: #DCDCDC;\n  border-collapse: collapse;\n  width: 100%; }\n\ntable.main button.add-album {\n  background: #ABC4FF; }\n\ntable.main button.add-album.active {\n  background: #3975FF; }\n\ntable.tracks {\n  background-color: #F0F8FF;\n  width: 100%; }\n\ntable.tracks button.add-track {\n  background: #ABC4FF; }\n\ntable.tracks button.add-track.active {\n  background: #3975FF; }\n\ntable.tracks button.play-track {\n  background: #ff8080; }\n\ntable.tracks button.play-track.active {\n  background: #990000; }\n\ntable, td, th {\n  border: 1px solid black; }\n\n#maincontainer {\n  width: 100%;\n  height: 100%; }\n\n#leftcolumn {\n  display: inline-block;\n  text-align: left;\n  width: 75%;\n  height: 100%;\n  background-color: white; }\n\n#contentwrapper {\n  display: inline-block;\n  text-align: right;\n  width: 25%;\n  height: 100%;\n  background-color: white; }\n\n/* new 3-cloumn style */\nmain {\n  float: left;\n  width: 60%;\n  margin-left: 20%; }\n\n.aside-left {\n  float: left;\n  width: 20%;\n  position: fixed;\n  left: 0; }\n\n.aside-right {\n  float: left;\n  width: 20%; }\n", ""]);
...
function reactingOnClicks(event) {
    ...
    switch (mainClassName) {
        case 'add-album':
            {
                (0, _player.albumToggle)(id, already);
                break;
            }
        case 'add-random':
            {
        ...
        case 'add-track':
            {
                (0, _player.trackToggle)(id, already);
                break;
            }
        default:
            {
